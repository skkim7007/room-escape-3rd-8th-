...
(() => {
  ...
  function modalMarkup() {
    ...
    if (type === 'pageA') body = `<div class="eyebrow">습득한 단서</div><h2>찢어진 종이 A</h2><div class="clue-paper">Eight Chinese characters<br>appear in Munja<span class="cut">do...</span><br><br><span class="cut">Three...</span> carp came out of the <span class="cut">water...</span></div><p>오른쪽 절반이 있어야 내용을 읽을 수 있다.</p><div class="modal-actions"><button class="button primary" data-action="closeModal">접어 둔다</button></div>`;
    if (type === 'restoredNote') body = `<div class="eyebrow">조합 성공</div><h2>복원된 문자도의 기록</h2><div class="clue-paper">Eight Chinese characters appear in Munjado.<br><br>Munjado is one type of folk painting.<br><br>Three carp came out of the water.<br><br>Children learned harmony in two places: family and society.<br><br><em>“네 문장을 처음부터 차례로 읽어라.”</em></div><p>도서관 문은 네 자리 숫자를 기다리고 있다.</p><div class="modal-actions"><button class="button primary" data-action="closeModal">기록한다</button></div>`;
